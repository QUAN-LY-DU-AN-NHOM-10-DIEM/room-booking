    ...
    >
      ...
      {booking && (
        <div className="modal__boday">
          <p className="modal__paragraph"><strong>Title: </strong>{booking.title || 'Meeting'}</p>
          ...
          <p className="modal__paragraph"><strong>Room: </strong>{findRoomInfo(booking.roomId, props.roomData)?.name || 'Unknown'}{', Level '}
          {findRoomInfo(booking.roomId, props.roomData)?.floor || 'N/A'}</p>
